...
class ProfileController extends Controller
{
    public function index()
    {
        ...
        // === Distribusi Nilai dari rapot_siswas ===
        $rapot = RapotSiswa::with('mapel')
        ...
        // === Ambil semua kursus sesuai kelas user ===
        ...
        // === Peringkat kelas ===
        $kelas = $profile->kelas;
        $siswaSeangkatan = Profile::whereHas('kelas', function ($q) use ($kelas) {
        ...
        foreach ($siswaSeangkatan as $s) {
            $totalNilai = RapotSiswa::where('siswa_id', $s->user_id)->sum('nilai');
            $rankingData->push([
                'user_id' => $s->user_id,
        ...
        return view('LMS.profile', compact(
            'user',
            'profile',
            'chartLabels',
            'chartData',
    ...
    public function cariUser(Request $request)
    {
        ...
        return view('LMS.cariUser', compact('profiles', 'kelasList'));
    }
    ...
    public function detailUser($id)
    {
        ...
        return view('LMS.detailCariUser', compact(
            'user',
            'profile',
            'chartLabels',
            'chartData',
