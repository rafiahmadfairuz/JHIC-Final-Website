        ...
        <div id="sidebar"
            ...
            <div class="p-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-white font-bold text-lg">SMK Krian 1</h1>
...
{{ Route::is('profileSekolah*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-school mr-3
        {{ Route::is('profileSekolah*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                    ...
                    <a href="{{ route('guru.index') }}"
                        class="nav-item flex items-center px-4 py-3 rounded-lg transition-colors group
{{ Route::is('guru*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-user-tie mr-3
        {{ Route::is('guru*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                        <span>Guru</span>
                    </a>
                    ...
                    <a href="{{ route('pertanyaan.index') }}"
                        class="nav-item flex items-center px-4 py-3 rounded-lg transition-colors group
{{ Route::is('pertanyaan*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-question-circle mr-3
        {{ Route::is('pertanyaan*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                    ...
                    <a href="{{ route('alumni.index') }}"
                        class="nav-item flex items-center px-4 py-3 rounded-lg transition-colors group
{{ Route::is('alumni*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-users mr-3
        {{ Route::is('alumni*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                        <span>Alumni</span>
                    </a>

                    <!-- Maskot -->
                    <a href="{{ route('maskot.index') }}"
                        class="nav-item flex items-center px-4 py-3 rounded-lg transition-colors group
{{ Route::is('maskot*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-paw mr-3
        {{ Route::is('maskot*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                        <span>Maskot</span>
                    </a>
                    <!-- Dashboard KWU -->
                    <a href="{{ route('dashboard.kwu.index') }}"
                        class="nav-item flex items-center px-4 py-3 rounded-lg transition-colors group
{{ Route::is('dashboard.kwu*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-store mr-3
{{ Route::is('dashboard.kwu*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                        <span>Dashboard KWU</span>
                    </a>

                    <!-- Dashboard Job Fair -->
                    <a href="{{ route('dashboard.jobfair.index') }}"
                        class="nav-item flex items-center px-4 py-3 rounded-lg transition-colors group
{{ Route::is('dashboard.jobfair*') ? 'bg-blue-700 text-white' : 'text-white hover:bg-blue-700' }}">
                        <i
                            class="fas fa-briefcase mr-3
{{ Route::is('dashboard.jobfair*') ? 'text-white' : 'text-blue-200 group-hover:text-white' }}">
                        </i>
                        <span>Dashboard Job Fair</span>
                    </a>
